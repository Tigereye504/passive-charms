...
public class FreefallTriggerRecipe extends SpecialCraftingRecipe {

    public FreefallTriggerRecipe(Identifier id) {
        super(id);
    }
    ...
    public ItemStack craft(CraftingInventory inv) {
        return new ItemStack(PC_Items.FREEFALL_TRIGGER);
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return PC_Recipes.FREEFALL_TRIGGER;
    }
