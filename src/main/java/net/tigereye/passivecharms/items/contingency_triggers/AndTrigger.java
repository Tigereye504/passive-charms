...
public class AndTrigger extends Item implements ContingencyCharmTrigger, TooltipNester {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if(stack != null) {
            ...
            user.getInventory().insertStack(new ItemStack(Items.COMPARATOR,1));
            stack.decrement(1);
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("item.passivecharms.contingency_charm_trigger_and.tooltip.description"));
